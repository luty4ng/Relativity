...
public class OrbitDebugger : MonoBehaviour
{
    ...
    public SimulatedBody centralBody;
    ...
    Vector3 CalculateAcceleration(int i, VirtualBody[] virtualBodies)
    {
        ...
        for (int j = 0; j < virtualBodies.Length; j++)
        {
            ...
            acceleration += forceDir * Universe.DefaultGravitationalConstant * virtualBodies[j].mass / sqrDst;
        }
        return acceleration;
    }
    ...
    void OnValidate()
    {
        ...
        {
            timeStep = Universe.DefaultPhysicsTimeStep;
        }
    }
